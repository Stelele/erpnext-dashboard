...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20251226165936_AddedAuth0UserIdField")]
    partial class AddedAuth0UserIdField
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SiteUser", b =>
                {
                    b.HasOne("Domain.Sites.Site", null)
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_site_user_sites_sites_id");
                    ...
                    b.HasOne("Domain.Users.User", null)
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_site_user_users_users_id");
                });
